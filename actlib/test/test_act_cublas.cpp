...
int main() {
    std::cout << "=== ACT_cuBLAS_f Smoke Test (cuBLAS GEMV + IAMAX) ===\n\n";
    try {
        ...
        ACT_cuBLAS_f act(fs, length, ranges, true);
        ...
        // Quick dictionary search (cuBLAS path for float32)
        ...
        std::cout << "\n=== ACT_cuBLAS_f Smoke Test complete ===\n";
        return 0;
